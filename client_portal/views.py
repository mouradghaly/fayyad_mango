    ...
    if request.method == "GET":
        ...
        for order in mymodel:
            if order.order_status != "Delivered":
                orders.append({"id": order.id, "name": order.name, "lastname": order.lastname, "phonenumber": order.phonenumber, "description": order.order_description, "status": order.order_status})
